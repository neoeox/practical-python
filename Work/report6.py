...
# python Work/report.py Work/Data/portfolio.csv Work/Data/prices.csv
...
# porfolio = read_portfolio('Data/missing.csv')
# for row in porfolio:
#     print(row)
# print("=" * 100)
# porfolio = read_portfolio('Data/missing.csv', silence_errors=True)
# for row in porfolio:
#     print(row)
